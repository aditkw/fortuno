...
class Services extends Backend_Controller
{
	...
	function index()
	{
		...
		$this->data['catservices'] 		= $this->catservices_model->get();
	...
	public function action($param)
	{
		...
		if (!empty($post)) {
			...
			$array_data['catservices_id'] 	= $post['catservices'];
			$array_data['services_name'] 	= $post['name'];
			$array_data['services_name_en'] 	= $post['name_en'];
			$array_data['services_desc'] 	= $post['desc'];
			$array_data['services_desc_en'] 	= $post['desc_en'];
	...
	public function update_load()
	{
		...
		$this->data['title_en'] 	= $get_data->services_name_en;
		$this->data['desc'] 		= $get_data->services_desc;
		$this->data['desc_en'] 		= $get_data->services_desc_en;
