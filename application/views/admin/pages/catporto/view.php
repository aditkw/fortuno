...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Category Portofolio</li>
		</ol>
	</section>
		...
		<div class="box">
			<div class="box-body">
				...
				<table id="datatable1" class="table table-striped">
					...
					<tbody>
						<?php $no = 1; foreach ($catporto as $catporto): ?>
							<tr>
								<td><?php echo $no;?></td>
								<td><img src="<?=site_url('uploads/img/catporto/thumb-'.$catporto->image_name)?>" alt=""></td>
								<td><?php echo ucwords($catporto->catporto_name_en);?></td>
								<td><?php echo limitKalimat($catporto->catporto_desc_en, 151);?></td>
								<td>
									<!-- Action -->
									<?php if ($catporto->catporto_pub == '88'): ?>
										<a href="<?php echo site_url('admin/catporto/action/publish?id='.hash_link_encode($catporto->catporto_id));?>" class="btn btn-flat btn-danger" title="Publish">
											<i class="fa fa-bullhorn"></i>
										</a>
									<?php else: ?>
										<a href="<?php echo site_url('admin/catporto/action/publish?id='.hash_link_encode($catporto->catporto_id));?>" class="btn btn-flat btn-success" title="Publish">
											<i class="fa fa-bullhorn"></i>
										</a>
									<?php endif ?>
									<a class="btn btn-flat btn-default btn-edit-catporto" data-id="<?php echo hash_link_encode($catporto->catporto_id);?>" title="Update">
										<i class="fa fa-edit"></i>
									</a>
									<a onclick="return confirm('Are you sure ?')"  href="<?php echo site_url('admin/catporto/action/delete?id='.hash_link_encode($catporto->catporto_id));?>" class="btn btn-warning btn-flat" title="Delete">
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Add Category Portofolio</h4>
			</div>
			<?php echo form_open_multipart('admin/catporto/action/insert');?>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<div class="form-group">
								<label for="catporto">Title</label>
								<input type="text" name="name" class="form-control" placeholder="title">
							</div>
							<div class="form-group">
								<label for="catporto">Description</label>
...
<div id="update" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Update Our catporto</h4>
			</div>
			<?php echo form_open_multipart('admin/catporto/action/update');?>
			<div class="modal-body">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
